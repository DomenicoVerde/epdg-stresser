...
func (identification *IdentificationInitiator) marshal() ([]byte, error) {
	//Info("[Identification] marshal(): Start marshalling")
...
func (identification *IdentificationInitiator) unmarshal(rawData []byte) error {
	//Info("[Identification] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[Identification] unmarshal(): Payload length %d bytes", len(rawData))

	if len(rawData) > 0 {
		//Trace("[Identification] unmarshal(): Unmarshal 1 identification")
		// bounds checking
		if len(rawData) <= 4 {
...
func (certificate *Certificate) marshal() ([]byte, error) {
	//Info("[Certificate] marshal(): Start marshalling")
...
func (certificate *Certificate) unmarshal(rawData []byte) error {
	//Info("[Certificate] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[Certificate] unmarshal(): Payload length %d bytes", len(rawData))

	if len(rawData) > 0 {
		//Trace("[Certificate] unmarshal(): Unmarshal 1 certificate")
		// bounds checking
		if len(rawData) <= 1 {
...
func (authentication *Authentication) marshal() ([]byte, error) {
	//Info("[Authentication] marshal(): Start marshalling")
...
func (authentication *Authentication) unmarshal(rawData []byte) error {
	//Info("[Authentication] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[Authentication] unmarshal(): Payload length %d bytes", len(rawData))

	if len(rawData) > 0 {
		//Trace("[Authentication] unmarshal(): Unmarshal 1 authentication")
		// bounds checking
		if len(rawData) <= 4 {
...
func (del *Delete) marshal() ([]byte, error) {
	//Info("[Delete] marshal(): Start marshalling")
...
func (del *Delete) unmarshal(rawData []byte) error {
	//Info("[Delete] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[Delete] unmarshal(): Payload length %d bytes", len(rawData))

	if len(rawData) > 0 {
		//Trace("[Delete] unmarshal(): Unmarshal 1 delete")
		// bounds checking
		if len(rawData) <= 4 {
...
func (trafficSelector *TrafficSelectorInitiator) marshal() ([]byte, error) {
	//Info("[TrafficSelector] marshal(): Start marshalling")
		...
		for _, individualTrafficSelector := range trafficSelector.TrafficSelectors {
			if individualTrafficSelector.TSType == TS_IPV4_ADDR_RANGE {
				...
				if len(individualTrafficSelector.StartAddress) != 4 {
					//Errorf("Address length %d", len(individualTrafficSelector.StartAddress))
...
func (trafficSelector *TrafficSelectorInitiator) unmarshal(rawData []byte) error {
	//Info("[TrafficSelector] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[TrafficSelector] unmarshal(): Payload length %d bytes", len(rawData))

	if len(rawData) > 0 {
		//Trace("[TrafficSelector] unmarshal(): Unmarshal 1 traffic selector")
		// bounds checking
		if len(rawData) < 4 {
...
func (encrypted *Encrypted) marshal() ([]byte, error) {
	//Info("[Encrypted] marshal(): Start marshalling")

	if len(encrypted.EncryptedData) == 0 {
		//Warn("[Encrypted] The encrypted data is empty")
	}
...
func (encrypted *Encrypted) unmarshal(rawData []byte) error {
	//Info("[Encrypted] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[Encrypted] unmarshal(): Payload length %d bytes", len(rawData))
...
func (configuration *Configuration) marshal() ([]byte, error) {
	//Info("[Configuration] marshal(): Start marshalling")
...
func (configuration *Configuration) unmarshal(rawData []byte) error {
	//Info("[Configuration] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[Configuration] unmarshal(): Payload length %d bytes", len(rawData))
	...
	if len(rawData) > 0 {
		...
		for len(configurationAttributeData) > 0 {
			//Trace("[Configuration] unmarshal(): Unmarshal 1 configuration attribute")
			// bounds checking
...
func (eap *EAP) marshal() ([]byte, error) {
	//Info("[EAP] marshal(): Start marshalling")
...
func (eap *EAP) unmarshal(rawData []byte) error {
	//Info("[EAP] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[EAP] unmarshal(): Payload length %d bytes", len(rawData))

	if len(rawData) > 0 {
		//Trace("[EAP] unmarshal(): Unmarshal 1 EAP")
		// bounds checking
		if len(rawData) < 4 {
...
func (eapIdentity *EAPIdentity) marshal() ([]byte, error) {
	//Info("[EAP][Identity] marshal(): Start marshalling")
...
func (eapIdentity *EAPIdentity) unmarshal(rawData []byte) error {
	//Info("[EAP][Identity] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[EAP][Identity] unmarshal(): Payload length %d bytes", len(rawData))
...
func (eapNotification *EAPNotification) marshal() ([]byte, error) {
	//Info("[EAP][Notification] marshal(): Start marshalling")
...
func (eapNotification *EAPNotification) unmarshal(rawData []byte) error {
	//Info("[EAP][Notification] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[EAP][Notification] unmarshal(): Payload length %d bytes", len(rawData))
...
func (eapNak *EAPNak) marshal() ([]byte, error) {
	//Info("[EAP][Nak] marshal(): Start marshalling")
...
func (eapNak *EAPNak) unmarshal(rawData []byte) error {
	//Info("[EAP][Nak] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[EAP][Nak] unmarshal(): Payload length %d bytes", len(rawData))
...
func (eapExpanded *EAPExpanded) marshal() ([]byte, error) {
	//Info("[EAP][Expanded] marshal(): Start marshalling")
	...
	if len(eapExpanded.VendorData) == 0 {
		//Warn("[EAP][Expanded] marshal(): EAP vendor data field is empty")
...
func (eapExpanded *EAPExpanded) unmarshal(rawData []byte) error {
	//Info("[EAP][Expanded] unmarshal(): Start unmarshalling received bytes")
	//Tracef("[EAP][Expanded] unmarshal(): Payload length %d bytes", len(rawData))
